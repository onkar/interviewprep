...
/**
 * This sample code is showing an example of thread signaling. Sometimes, a
 * thread can be woken up spuriously, i.e. a thread which calls wait() might get
 * woken up without some other thread calling notify(). This code handles this
 * situation by using a spinlock.
 * 
